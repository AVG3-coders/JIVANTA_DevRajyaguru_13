...
import { Clipboard, FileText, RefreshCw, Bell, ArrowRight, Star } from "lucide-react"
  ...
  return (
    <main className="min-h-screen flex flex-col bg-background">
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <span className="inline-block px-3 py-1 bg-white/20 rounded-full text-sm font-medium backdrop-blur-sm">Healthcare Excellence</span>
              ...
              <div className="flex gap-4">
                <Button variant="highlight" size="lg" className="rounded-full shadow-lg hover:shadow-xl transition-all">
                  Get Started <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
                <Button variant="outline" size="lg" className="rounded-full bg-white/20 backdrop-blur-sm border-white/40 hover:bg-white/30 transition-all">
                  Learn More
                </Button>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-[hsl(var(--background))]">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 bg-[hsl(var(--muted))] text-[hsl(var(--tertiary))] rounded-full text-sm font-medium mb-4">Our Services</span>
            <h2 className="text-4xl font-bold text-[hsl(var(--primary))] mb-4">Comprehensive Healthcare Solutions</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We provide professional healthcare services to meet all your medical needs with expert care and attention.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-green-200/50">
              ...
              <h3 className="text-xl font-semibold mb-3">Application Preparation</h3>
              <p className="text-muted-foreground">Assistance with medical forms and insurance applications</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-purple-200/50">
              ...
              <h3 className="text-xl font-semibold mb-3">Documentation Review</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-amber-200/50">
              ...
              <h3 className="text-xl font-semibold mb-3">Updates and Reports</h3>
              <p className="text-muted-foreground">Regular health updates and comprehensive medical reports</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[hsl(var(--muted))]">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 bg-white text-[hsl(var(--tertiary))] rounded-full text-sm font-medium mb-4">Testimonials</span>
            <h2 className="text-4xl font-bold text-[hsl(var(--primary))] mb-4">Our Trusted Client Says</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl p-10 shadow-lg relative">
            <div className="text-6xl text-[hsl(var(--tertiary))] opacity-20 absolute top-4 left-4">"</div>
            <div className="text-6xl text-[hsl(var(--tertiary))] opacity-20 absolute bottom-4 right-4">"</div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div>
                <div className="flex mb-4">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Star key={i} className="h-5 w-5 fill-[hsl(var(--chart-4))] text-[hsl(var(--chart-4))]" />
                  ))}
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-[hsl(var(--primary))]">John Smith</h4>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg md:shadow-xl p-6 md:p-10 border border-[hsl(var(--border))]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
              <div className="order-2 md:order-1">
                <span className="inline-block px-3 md:px-4 py-1 bg-[hsl(var(--muted))] text-[hsl(var(--tertiary))] rounded-full text-sm font-medium mb-3 md:mb-4">About Us</span>
                <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-[hsl(var(--primary))]">Our Story</h3>
                ...
                <ul className="space-y-2 md:space-y-3">
                  <li className="flex items-center">
                    ...
                    <span className="text-sm md:text-base">Certified healthcare professionals</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[hsl(var(--chart-2))] flex items-center justify-center mr-3">
                      <svg className="w-2.5 h-2.5 md:w-3 md:h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-sm md:text-base">Trusted by thousands of clients</span>
                  </li>
                </ul>
              </div>
              <div className="bg-[hsl(var(--muted))] rounded-lg md:rounded-xl p-6 md:p-8 order-1 md:order-2 mb-6 md:mb-0">
                <span className="inline-block px-3 md:px-4 py-1 bg-white text-[hsl(var(--tertiary))] rounded-full text-sm font-medium mb-3 md:mb-4">Contact Us</span>
                <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-[hsl(var(--primary))]">Get In Touch</h3>
                <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                  <div className="flex flex-wrap items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center mr-3 md:mr-4 shadow-sm mb-2 md:mb-0">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[hsl(var(--tertiary))]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                      </svg>
                    </div>
                    <span className="text-sm md:text-base break-all">support@medishop.com</span>
                  </div>
                  <div className="flex flex-wrap items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center mr-3 md:mr-4 shadow-sm mb-2 md:mb-0">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[hsl(var(--tertiary))]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex flex-wrap items-start">
                    ...
                    <span className="text-sm md:text-base flex-1">123 Health Street, Medical District, NY 10001</span>
                  </div>
                </div>
                <div className="flex gap-3">
                  <Button variant="highlight" size="lg" className="rounded-full flex-1">
                    Login <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                  <Button variant="outline" size="lg" className="rounded-full flex-1 bg-white/90 hover:bg-white border-[hsl(var(--tertiary))]">
                    Register
                  </Button>
                </div>
              </div>
